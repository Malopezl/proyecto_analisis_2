...
import static org.marcos.sql.InventarioSql.LNOMBRE;
...
public class Revision_nombre implements Opcion {
    ...
    public DefaultTableModel Crear(Inventario inventario) {
        ...
        modelo = t.getModelo();
        try {
            ResultSet rs = LNOMBRE(inventario.getNombre());
            ...
            Logger.getLogger(Revision_nombre.class.getName()).log(Level.SEVERE, null, ex);
        }
        return modelo;
